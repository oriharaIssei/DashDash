...
void TireSplinePoints::Initialize(Scene* /*_scene*/, const EntityHandle& /*_owner*/) {}

void TireSplinePoints::Edit(Scene* /*_scene*/, const EntityHandle& /*_handle*/, [[maybe_unused]] const std::string& _parentLabel) {
#ifdef _DEBUG
